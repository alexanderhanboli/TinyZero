...
export PROJECT_NAME=TinyZero-grpo
...
scitat_train_path=$HOME/efs/tinyzero/scitat/train.parquet
scitat_test_path=$HOME/efs/tinyzero/scitat/test.parquet

train_files="['$math_train_path', '$qrtext_train_path', '$scitat_train_path']"
test_files="['$qrtext_test_path', '$scitat_test_path']"
